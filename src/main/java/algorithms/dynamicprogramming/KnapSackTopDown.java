...
public class KnapSackTopDown {
    ...
    public int maxValue(int[]weight,int value[],int W,int n,int[][]memMatrix){
        ...
        //weight= array of weights of item //array of value of items //W total weight of the Knapsack
        ...
        if(memMatrix[n][W]!= -1) return memMatrix[n][W];

        if(weight[n-1]<=W){
            return memMatrix[n][W]=Math.max(value[n-1] + maxValue(weight,value,W-weight[n-1],n-1,memMatrix),
